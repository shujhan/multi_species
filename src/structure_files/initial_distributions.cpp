...
void F0_ion_acoustic_electron::print() {
    ...
    cout << "1.0 / sqrt(2.0 * M_PI) / pth * exp(-(p-p_str)*(p-p_str) / 2 / pth /pth) * ( 1 + amp * cos(k * x ))" << endl;
...
void F0_ion_acoustic_ion::print() {
    ...
    cout << "1.0 / sqrt(2.0 * M_PI) / pth * exp(-(p-p_str)*(p-p_str) / 2 / pth /pth)* ( 1 + amp * cos(k * x ))" << endl;
    // cout << "1.0 / sqrt(2.0 * M_PI) / pth * exp(-(p - amp * 0.091* sin(k * x ))*(p- amp *0.091* sin(k * x )) / 2 / pth /pth) * ( 1 + amp * cos(k * x ))" << endl;
